...
from app.models.users import AssignRole, UserUpdateSchema, SetNewPassword
from bson.objectid import ObjectId
from app.services.oauth2 import check_auth, check_admin
from app.services.user import userSerializers, PasswordService, users_log
...
async def assign_role(
    ...
    updated_user_data = user_db.find_one_and_update(
        ...
        {"$set": {"is_admin": user.is_admin, "updated_at": datetime.utcnow()}}
    )
